...
CREATE TABLE `car_type` (
  ...
  `CAR_COUPE` varchar(30) NOT NULL,
  PRIMARY KEY (`ID_CAR_TYPE`),
  UNIQUE KEY `ID_CAR_TYPE_UNIQUE` (`ID_CAR_TYPE`)
...
INSERT INTO `car_type` VALUES (1,'Car','Sedan'),(2,'Car','Hachback'),(3,'Car','Coupe'),(4,'Car','Sport'),(5,'Car','Convertilble'),(6,'Car','Minivan'),(7,'Car','Pickup Truck');
